  ...
  <div class="site-demo site-demo-body">
    ...
    <lay-collapse>
      <lay-collapse-item :index="0">
        <template slot="title"
          >为什么JS社区大量采用未发布或者未广泛支持的语言特性？</template
        >
        <p>
      ...
      <lay-collapse-item :index="1">
        <template slot="title"
          >为什么前端工程师多不愿意用 Bootstrap 框架？</template
        >
        <p>
      ...
      <lay-collapse-item :index="2">
        <template slot="title"
          >vue-layui 更适合哪些开发者？</template
        >
        <p>
          layui是前后端开发者都比较喜欢的框架，由于各种不可描述的原因，有的老板要求前端开发者既要使用vue又要用layui，因此vue-layui诞生了。
        </p>
      </lay-collapse-item>
